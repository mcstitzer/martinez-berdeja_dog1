...
read SAMPLEID SRRNUM TRASH MORETRASH <<< $(sed -n "${SLURM_ARRAY_TASK_ID}p" sra_1135.tosample.txt)
echo $SAMPLENAME
echo $SRRNUM
...
echo assembled_out/${SRRNUM}.fna.contigs
if [ ! -f "assembled_out/${SRRNUM}.fna.contigs" ]
then
